...
export default function Fichas(){
  ...
  const filtered = useMemo(()=>{
    ...
    const base = docs.filter(d => String(d.category||"").toLowerCase()==="fichas" && (d.active ?? true));
    if(!s) return base;
  ...
  const downloadAndShare = async (doc)=>{
    try{
      ...
      let name = sanitize(metaName || doc.fileName || doc.title || "ficha");
  ...
  return (
    <Screen>
      <TextInput
        placeholder="Buscar ficha o tag..."
